...
//        };
    ...
    .controller('purchaseOrdersCtrl', function
        ...
        $scope.messages = purchaseOrders;

        $scope.refresh = function () {
            purchaseOrderFactory.purchaseOrdersadd(3).then(function () {
        ...
        $scope.loadMore = function () {
            purchaseOrderFactory.purchaseOrdersadd($scope.messages.length + 1).then(function () {
                $scope.messages = purchaseOrderFactory.purchaseOrderArray;
            });
